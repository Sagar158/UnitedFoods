...
(function($) {
  ...
  $(function() {
    ...
    var themeSidebar = localStorage.getItem("theme-sidebar");
    ...
    $("input:radio[name=sidebarThemeSettings]").click(function() {
      ...
      localStorage.setItem("theme-sidebar", $(this).val());
     })
  ...
  // close sidebar when click outside on mobile/table
    ...
    if(themeSidebar !== null && themeSidebar !== undefined)
    {
        $('body').removeClass('sidebar-light sidebar-dark');
        $('body').addClass(themeSidebar);
        $("input[name='sidebarThemeSettings'][value='"+themeSidebar+"']").prop('checked', true);
    }
